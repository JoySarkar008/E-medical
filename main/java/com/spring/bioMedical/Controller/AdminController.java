...
public class AdminController {
	...
	@Autowired
	public AdminController(UserService userService, AdminService adminService, AdminServiceImplementation obj,
	...
	public String showFormForAdd(Model theModel) {
		...
		theModel.addAttribute("doctor", admin);//here the "doctor" is the object
	...
	public String saveEmployee(@ModelAttribute("doctor") Admin admin) {//here admin is entity
		...
		return "redirect:http://localhost:8080/admin/doctor-details";
	}
	
	@GetMapping("/editDoctor/{id}")
	public String EditDocForm(@PathVariable Long id, Model theModel) {
		
		theModel.addAttribute("doctor", adminService.getDoctorById(id));
		
		return "admin/editDoctor";
	}
	
	@PostMapping("/updateDoc")
	public String updateDoc(@ModelAttribute("profile") Admin admin) {
	...
	public String saveEmploye(@ModelAttribute("doctor") Admin admin) {
		...
		return "redirect:http://localhost:8080/admin/admin-details";
	}
